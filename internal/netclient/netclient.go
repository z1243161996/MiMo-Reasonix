// Package netclient builds HTTP clients and proxy resolvers that share MiMo-Reasonix's
...
import (
	...
	"mimo-reasonix/internal/sysproxy"
)
...
// NewHTTPClient returns an HTTP client with MiMo-Reasonix proxy settings applied.
