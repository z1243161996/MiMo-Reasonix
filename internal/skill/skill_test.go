...
func TestListPrecedenceProjectOverGlobal(t *testing.T) {
	home := t.TempDir()
	proj := t.TempDir()
	writeSkill(t, proj, ".mimo-reasonix/skills/greet.md", "---\nname: greet\ndescription: project greet\n---\nproject body")
	writeSkill(t, home, ".mimo-reasonix/skills/greet.md", "---\ndescription: global greet\n---\nglobal body")
	writeSkill(t, home, ".mimo-reasonix/skills/onlyglobal.md", "---\ndescription: only global\n---\nbody")
...
func TestFlatAndDirLayout(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/flat.md", "---\ndescription: flat\n---\nflat body")
	writeSkill(t, home, ".mimo-reasonix/skills/dir/SKILL.md", "---\ndescription: dir\n---\ndir body")
...
func TestNestedSkillsDiscoveredByDefault(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/superpower/skill-a.md", "---\ndescription: nested flat\n---\nflat body")
	writeSkill(t, home, ".mimo-reasonix/skills/superpower/tool-a/SKILL.md", "---\ndescription: nested dir\n---\ndir body")
	writeSkill(t, home, ".mimo-reasonix/skills/superpower/references/notes.md", "---\ndescription: not a skill\n---\nnotes")
...
func TestNestedSkillsRequireDescription(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/root.md", "---\n---\nroot body")
	writeSkill(t, home, ".mimo-reasonix/skills/superpower/draft.md", "---\n---\ndraft body")
	writeSkill(t, home, ".mimo-reasonix/skills/superpower/tool/SKILL.md", "---\n---\ntool body")
...
func TestNestedDirectorySkillStopsTraversal(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/pack/SKILL.md", "---\ndescription: pack\n---\npack body")
	writeSkill(t, home, ".mimo-reasonix/skills/pack/child.md", "---\ndescription: child\n---\nchild body")
...
func TestReasonixHomeDirOverridesGlobalReasonixSkills(t *testing.T) {
	...
	writeSkill(t, home, ".mimo-reasonix/skills/old.md", "---\ndescription: old\n---\nold")
	writeSkill(t, home, ".mimo-reasonix/skills/current.md", "---\ndescription: old current\n---\nold current")
	...
	if _, ok := find(list, "old"); !ok {
		t.Fatal("legacy ~/.mimo-reasonix skill should remain discoverable")
	}
...
func TestExcludedPathsHideConventionRoots(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/keep.md", "---\ndescription: keep\n---\nb")
...
func TestFrontmatterFields(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/sub.md",
		"---\ndescription: a sub\nrunAs: subagent\nallowed-tools: read_file, grep\nmodel: deepseek-pro\n---\nbody")
	writeSkill(t, home, ".mimo-reasonix/skills/fork.md", "---\ndescription: f\ncontext: fork\n---\nbody")
	writeSkill(t, home, ".mimo-reasonix/skills/plain.md", "---\ndescription: p\n---\nbody")
...
func TestReferencesInlined(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/withrefs/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeSkill(t, home, ".mimo-reasonix/skills/withrefs/references/b.md", "second ref")
	writeSkill(t, home, ".mimo-reasonix/skills/withrefs/references/a.md", "first ref")
...
func TestScriptsAppended(t *testing.T) {
	...
	writeSkill(t, home, ".mimo-reasonix/skills/withscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeScript(t, home, ".mimo-reasonix/skills/withscripts/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')")
	writeScript(t, home, ".mimo-reasonix/skills/withscripts/scripts/deploy.sh", "#!/usr/bin/env bash\necho ok")
...
func TestNoScriptsWhenDirAbsent(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/noscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	st := New(Options{HomeDir: home, DisableBuiltins: true})
...
func TestScriptsFilteredByExt(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/scriptscheck/SKILL.md", "---\ndescription: t\n---\nbody")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')\n")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/.hidden.py", "")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/readme.md", "# readme")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/deploy", "#!/bin/sh\necho ok")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/legacy.p", "print 'ok'\n")
	writeScript(t, home, ".mimo-reasonix/skills/scriptscheck/scripts/.gitkeep", "")
...
func TestBuiltinsPresentAndOverridable(t *testing.T) {
	...
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/explore.md", "---\ndescription: mine\nrunAs: inline\n---\nbody")
...
func TestDisabledSkillsAreFilteredFromListAndRead(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/active.md", "---\ndescription: active\n---\nbody")
	writeSkill(t, home, ".mimo-reasonix/skills/hidden.md", "---\ndescription: hidden\n---\nbody")
...
func TestInvalidNamesSkipped(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".mimo-reasonix/skills/bad name.md", "---\ndescription: x\n---\nb") // space → invalid
	st := New(Options{HomeDir: home, DisableBuiltins: true})
	if len(st.List()) != 0 {
...
func TestSymlinkedDirAndFile(t *testing.T) {
	...
	skillsRoot := filepath.Join(home, ".mimo-reasonix", "skills")
...
func TestCreateRefusesOverwrite(t *testing.T) {
	...
	if !strings.HasSuffix(path, filepath.Join(".mimo-reasonix", "skills", "mine", SkillFile)) {
	...
	writeSkill(t, home, ".mimo-reasonix/skills/legacy.md", "---\ndescription: legacy\n---\nbody")
