...
func legacyOfficialProviderModel(name string) string {
	...
	case "mimo", "xiaomi", "xiaomi-mimo", "xiaomi_mimo", "mimo-api", "mimo-token-plan", "mimo-pro", "xiaomi-pro":
...
// MiMo providers needed by legacy refs that live outside mimo-reasonix.toml, such as
...
func legacyMimoProviderName(ref string) string {
	...
	case "mimo", "xiaomi", "xiaomi-mimo", "xiaomi_mimo", "mimo-api", "mimo-token-plan", "mimo-pro", "xiaomi-pro", "mimo-flash":
...
func legacyMimoCustomProvider(name string) ProviderEntry {
	switch strings.TrimSpace(name) {
	case "mimo", "xiaomi", "xiaomi-mimo", "xiaomi_mimo", "mimo-api":
	...
	case "xiaomi-pro":
		return ProviderEntry{Name: "xiaomi-pro", Kind: "openai", BaseURL: "https://token-plan-cn.xiaomimimo.com/v1", Model: "mimo-v2.5-pro", APIKeyEnv: "MIMO_API_KEY", ContextWindow: 1_000_000, Price: mimoV25ProPrice(), NoProxy: true}
	default:
