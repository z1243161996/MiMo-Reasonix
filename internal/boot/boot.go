...
import (
	...
	"mimo-reasonix/internal/command"
	"mimo-reasonix/internal/config"
	"mimo-reasonix/internal/control"
	"mimo-reasonix/internal/environment"
	"mimo-reasonix/internal/event"
	"mimo-reasonix/internal/guardian"
	"mimo-reasonix/internal/history"
	"mimo-reasonix/internal/hook"
	"mimo-reasonix/internal/installsource"
	"mimo-reasonix/internal/instruction"
	"mimo-reasonix/internal/jobs"
	"mimo-reasonix/internal/lsp"
	"mimo-reasonix/internal/memory"
	"mimo-reasonix/internal/memorycompiler"
	"mimo-reasonix/internal/migration"
	"mimo-reasonix/internal/netclient"
	"mimo-reasonix/internal/outputstyle"
	"mimo-reasonix/internal/permission"
	...
	"mimo-reasonix/internal/tool/sessiontool"
)
...
func rememberPermissionConfigPath(workspaceRoot string) string {
	...
	if workspaceRoot != "" {
		return filepath.Join(workspaceRoot, "mimo-reasonix.toml")
	}
