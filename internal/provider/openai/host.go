...
// IsMiMo reports whether baseURL points at Xiaomi MiMo's API
// (token-plan-cn.xiaomimimo.com or any *.xiaomimimo.com subdomain).
func IsMiMo(baseURL string) bool {
	return matchesVendorHost(baseURL, "xiaomimimo.com", "token-plan-cn.xiaomimimo.com")
}
