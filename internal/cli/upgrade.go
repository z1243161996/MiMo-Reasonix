...
// extractBinary pulls the "mimo-reasonix" binary from a .tar.gz or .zip archive.
...
// rename it aside to .mimo-reasonix.old first, then place the new binary.
