...
// acpCommand runs MiMo-Reasonix as an Agent Client Protocol agent: a stdio JSON-RPC
...
func acpCommand(args []string, version string) int {
	...
	info := acp.AgentInfo{Name: "mimo-reasonix", Version: version}
