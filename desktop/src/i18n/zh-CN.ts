...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    editorDefault: "(默认)",
    apiKey: "API key",
    apiKeyHint: "MiMo key — 保存到 ~/.reasonix/config.json (0600)。",
    apiKeyNotSet: "(未设置)",
    apiKeyCancel: "取消",
    apiKeySave: "保存",
    apiKeyShow: "显示",
  ...
  effort: {
    ...
    maxDesc: "MiMo 扩展；标准 OpenAI / vLLM 会拒绝",
  },
  checkpoint: {
    title: "步骤已完成",
    progress: "{done} / {total}",
  ...
  app: {
    ...
    setup: {
      welcome: "欢迎使用 Reasonix",
      description: "首次使用需要配置 MiMo API Key 与工作目录。Key 仅保存在本地。",
      workspace: "工作目录",
      notSelected: "未选择",
      choose: "选择…",
      saveAndStart: "保存并开始",
